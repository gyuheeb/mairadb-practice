...
-- 문제3.(각 각 쿼리만들어 각 각 출력)
-- 여직원과 남직원은 각 각 몇 명이나 있나요?
select count(*) as '여직원'  from employees where gender = 'f';
select count(*) as '남직원'  from employees where gender = 'm';

-- 문제4.(현재 = to_date='9999-01-01'과 같다라는 조건)
-- 현재 근무하고 있는 직원 수는 몇 명입니까? (salaries 테이블을 사용합니다.) 
select count(*) as '현재직원' from salaries where to_date = '9999-01-01';

-- 문제5.
-- 부서는 총 몇 개가 있나요?
select distinct count(dept_name) as '부서' from departments;
